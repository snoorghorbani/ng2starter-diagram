...
var diagram_module_configuration_1 = require("../diagram-module-configuration");
...
var DiagramService = /** @class */ (function () {
    ...
    DiagramService.prototype.getData = function (source, time, once) {
        ...
        if (once && time !== 0) {
            ...
            return Rx_1.Observable
                ...
                return _this.http.get("http://localhost:3000/api/data", {
                    params: {
                        sourceId: source._id,
    ...
    DiagramService.ctorParameters = function () { return [
        ...
        { type: store_1.Store, },
        { type: diagram_module_configuration_1.DiagramConfigurationService, },
    ]; };
