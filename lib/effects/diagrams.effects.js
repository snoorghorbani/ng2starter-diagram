...
var DiagramEffects = /** @class */ (function () {
    function DiagramEffects(actions$, router, diagramService) {
        ...
        this.DiagramRequest$ = this.actions$
            ...
            .map(function (data) { return new actions_1.GetDiagramsStart(); });
        this.getDiagram$ = this.actions$
            .ofType()
            .map(effects_1.toPayload)
            .switchMap(function (data) {
            return _this.diagramService.getDiagrams()
                .map(function (res) { return new actions_1.GetDiagramsSucceed(res); })
                .catch(function () { return Observable_1.Observable.of(new actions_1.GetDiagramsFailed()); });
        });
    }
